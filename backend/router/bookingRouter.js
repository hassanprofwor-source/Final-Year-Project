...
import { saveBooking, getBookings, getMyBookings, updateBooking, getAvailability, cancelMyBooking, createReservationPayment } from "../controllers/bookingController.js";
...
router.post("/create-reservation-payment", createReservationPayment);
