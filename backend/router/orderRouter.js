...
import { saveOrder,getOrders,getOrderById,getOrder,getOrderDelivery,updateOrder,deleteOrder,getCompletedOrders, stripePayment, getOrderDine, stripePaymentDelivery, cancelPendingOrder } from "../controllers/orderController.js";
import { requireAdmin } from "../middlewares/requireAdmin.js";

const router = express.Router();
router.get("/getOrders", requireAdmin, getOrders);
router.get("/getOrderById/:id", requireAdmin, getOrderById);
